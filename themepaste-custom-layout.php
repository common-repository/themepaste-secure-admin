...
function wptpsa_custom_layout_status_input() {
    ...
    ?>
        <input id='custom_layout_status' name='wptpsa_layout_config[custom_layout_status]' size='40' type='checkbox' value='1' <?php echo '1'==$wptpsa_layout_config["custom_layout_status"] ? 'checked' : ''; ?> /> <span>Enable</span>
    <?php
}
